...
@Component({
  selector: 'app-semm3242-find-student',
  templateUrl: './semm3242-find-student.page.html',
  styleUrls: ['./semm3242-find-student.page.scss'],
})
export class Semm3242FindStudentPage implements OnInit {
  ...
  async getlist(){
    if (this.matric_number.length == 0) {
      ...
      this.http.get('https://asqsolution.com/instrument/get_matric_name.php', {params: prms1}).subscribe(data => {
        loading.dismiss();
        ...
        //this.http.get('http://localhost/instrument/get_name_data.php',{params:prms}).subscribe(data=>{
        this.http.get('https://asqsolution.com/instrument/get_list_data.php', {params: prms2}).subscribe(data => {
          this.data_list = <Array<any>> data
