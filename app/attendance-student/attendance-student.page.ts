...
@Component({
  ...
  templateUrl: './attendance-student.page.html',
  styleUrls: ['./attendance-student.page.scss'],
})
export class AttendanceStudentPage implements OnInit {
  ...
  async list_date(){
    ...
    const loading = await this.loadingController.create({
      message: 'Downloanding.Please wait..',
    });
    ...
    this.http.get('https://asqsolution.com/control/list_date.php',{params:prms}).subscribe(data => {
      loading.dismiss();
